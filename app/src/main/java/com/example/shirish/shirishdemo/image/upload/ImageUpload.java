package com.example.shirish.shirishdemo.image.upload;
...
public class ImageUpload extends AppCompatActivity {
    ...
    Button mBtnGetImage, mBtnUploadImage;
    ImageView mImgView;
    private Bitmap bitmap;

    private int PICK_IMAGE_REQUEST = 1;

    private String UPLOAD_URL = "http://192.168.1.101/Movies/upload.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnGetImage = (Button) findViewById(R.id.btn_open_gal);
        mBtnUploadImage = (Button) findViewById(R.id.btn_upload);
